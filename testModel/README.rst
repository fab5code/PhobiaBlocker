...
+------------------------+------------+----------+-----------+------------+------------+----------+--------+--------+
| Model                  | Total (ms) | Prep (ms)| Run (ms)  | Decision   | Threshold  | Precision| Recall | F1     |
+========================+============+==========+===========+============+============+==========+========+========+
| squeezenet1.1-7        | 13.2       | 0.6      | 12.1      | 0.5        | VERY_LOW   | 0.281    | 0.925  | 0.430  |
|                        |            |          |           |            | LOW        | 0.525    | 0.877  | 0.657  |
|                        |            |          |           |            | MEDIUM     | 0.640    | 0.848  | 0.729  |
|                        |            |          |           |            | HIGH       | 0.768    | 0.787  | 0.778  |
|                        |            |          |           |            | VERY_HIGH  | 0.827    | 0.743  | 0.783  |
+------------------------+------------+----------+-----------+------------+------------+----------+--------+--------+
| shufflenet-7           | 109.9      | 0.7      | 108.7     | 0.5        | VERY_LOW   | 0.275    | 0.907  | 0.422  |
|                        |            |          |           |            | LOW        | 0.535    | 0.835  | 0.652  |
|                        |            |          |           |            | MEDIUM     | 0.642    | 0.790  | 0.709  |
|                        |            |          |           |            | HIGH       | 0.747    | 0.703  | 0.724  |
|                        |            |          |           |            | VERY_HIGH  | 0.818    | 0.642  | 0.720  |
+------------------------+------------+----------+-----------+------------+------------+----------+--------+--------+
| shufflenet-v2-10       | 17.5       | 0.5      | 16.5      | 0.5        | VERY_LOW   | 0.400    | 0.965  | 0.565  |
|                        |            |          |           |            | LOW        | 0.681    | 0.917  | 0.782  |
|                        |            |          |           |            | MEDIUM     | 0.753    | 0.905  | 0.822  |
|                        |            |          |           |            | HIGH       | 0.825    | 0.873  | 0.848  |
|                        |            |          |           |            | VERY_HIGH  | 0.866    | 0.855  | 0.860  |
+------------------------+------------+----------+-----------+------------+------------+----------+--------+--------+
| efficientnet-lite4-11  | 21.4       | 0.3      | 20.5      | 0.5        | VERY_LOW   | 0.802    | 0.963  | 0.875  |
|                        |            |          |           |            | LOW        | 0.873    | 0.948  | 0.909  |
|                        |            |          |           |            | MEDIUM     | 0.895    | 0.943  | 0.918  |
|                        |            |          |           |            | HIGH       | 0.926    | 0.940  | 0.933  |
|                        |            |          |           |            | VERY_HIGH  | 0.930    | 0.935  | 0.933  |
+------------------------+------------+----------+-----------+------------+------------+----------+--------+--------+
| mobilenet_v4           | 12.5       | 0.7      | 11.3      | 0.5        | VERY_LOW   | 0.423    | 0.975  | 0.590  |
|                        |            |          |           |            | LOW        | 0.751    | 0.953  | 0.840  |
|                        |            |          |           |            | MEDIUM     | 0.836    | 0.932  | 0.882  |
|                        |            |          |           |            | HIGH       | 0.916    | 0.897  | 0.907  |
|                        |            |          |           |            | VERY_HIGH  | 0.942    | 0.855  | 0.896  |
+------------------------+------------+----------+-----------+------------+------------+----------+--------+--------+
